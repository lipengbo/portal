...
def do_listDatapathStats(dpid, flowvisor_url, flowviser_ps):
    req = {"dpid": dpid}
    ret = connect("list-datapath-stats", data=req, flowvisor_url=flowvisor_url, flowviser_ps=flowviser_ps)
    if len(ret) == 0:
        print "  None"
    else:
...
def do_list_links(flowvisor_url, flowviser_ps):
    ret = connect("list-links", data={}, flowvisor_url=flowvisor_url, flowviser_ps=flowviser_ps)
    if len(ret) == 0:
        print "  None"
    else:
        return ret
...
def do_list_datapaths(flowvisor_url, flowviser_ps):
    ret = connect("list-datapaths", data={}, flowvisor_url=flowvisor_url, flowviser_ps=flowviser_ps)
    if len(ret) == 0:
        print "  None"
    else:
        return ret
...
def do_list_datapath_info(dpid, flowvisor_url, flowviser_ps):
    ret = connect("list-datapath-info", data={'dpid': dpid}, flowvisor_url=flowvisor_url, flowviser_ps=flowviser_ps)
    if len(ret) == 0:
        print "  None"
    else:
        return ret
