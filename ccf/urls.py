...
urlpatterns = patterns("",
    ...
    url(r"^404error/", TemplateView.as_view(template_name="404error.html"), name="demo"),
    url(r"^500error/", TemplateView.as_view(template_name="500error.html"), name="demo"),
    url(r"^502error/", TemplateView.as_view(template_name="502error.html"), name="demo"),
