...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Subnet.owner'
        db.alter_column('ipam_subnet', 'owner', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Subnet.owner'
        db.alter_column('ipam_subnet', 'owner', self.gf('django.db.models.fields.CharField')(unique=True, max_length=60, null=True))
