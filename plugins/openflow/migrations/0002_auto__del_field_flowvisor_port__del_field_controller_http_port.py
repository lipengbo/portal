...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Flowvisor.port'
        db.delete_column('openflow_flowvisor', 'port')

        # Deleting field 'Controller.http_port'
        db.delete_column('openflow_controller', 'http_port')


    def backwards(self, orm):
        # Adding field 'Flowvisor.port'
        db.add_column('openflow_flowvisor', 'port',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Controller.http_port'
        db.add_column('openflow_controller', 'http_port',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
