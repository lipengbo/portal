...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Flowvisor.username'
        db.delete_column('openflow_flowvisor', 'username')

        # Deleting field 'Flowvisor.state'
        db.delete_column('openflow_flowvisor', 'state')

        # Deleting field 'Controller.state'
        db.delete_column('openflow_controller', 'state')


    def backwards(self, orm):
        # Adding field 'Flowvisor.username'
        db.add_column('openflow_flowvisor', 'username',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)

        # Adding field 'Flowvisor.state'
        db.add_column('openflow_flowvisor', 'state',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Controller.state'
        db.add_column('openflow_controller', 'state',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)
