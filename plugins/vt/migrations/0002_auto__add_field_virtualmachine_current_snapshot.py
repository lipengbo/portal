...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VirtualMachine.current_snapshot'
        db.add_column('vt_virtualmachine', 'current_snapshot',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VirtualMachine.current_snapshot'
        db.delete_column('vt_virtualmachine', 'current_snapshot')
    ...
    models = {
        ...
        'vt.virtualmachine': {
            ...
            'current_snapshot': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255', 'null': 'True'}),
