...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SSHKey.title'
        db.delete_column('vt_sshkey', 'title')

        # Deleting field 'SSHKey.user'
        db.delete_column('vt_sshkey', 'user_id')

        # Deleting field 'SSHKey.sshkey'
        db.delete_column('vt_sshkey', 'sshkey')

        # Adding field 'SSHKey.slice'
        db.add_column('vt_sshkey', 'slice',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['slice.Slice']),
                      keep_default=False)

        # Adding field 'SSHKey.name'
        db.add_column('vt_sshkey', 'name',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=256),
                      keep_default=False)

        # Adding field 'SSHKey.public_key'
        db.add_column('vt_sshkey', 'public_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'SSHKey.private_key'
        db.add_column('vt_sshkey', 'private_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True),
                      keep_default=False)

        # Adding field 'SSHKey.fingerprint'
        db.add_column('vt_sshkey', 'fingerprint',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'SSHKey.title'
        db.add_column('vt_sshkey', 'title',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=256),
                      keep_default=False)

        # Adding field 'SSHKey.user'
        db.add_column('vt_sshkey', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'SSHKey.sshkey'
        db.add_column('vt_sshkey', 'sshkey',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=500),
                      keep_default=False)

        # Deleting field 'SSHKey.slice'
        db.delete_column('vt_sshkey', 'slice_id')

        # Deleting field 'SSHKey.name'
        db.delete_column('vt_sshkey', 'name')

        # Deleting field 'SSHKey.public_key'
        db.delete_column('vt_sshkey', 'public_key')

        # Deleting field 'SSHKey.private_key'
        db.delete_column('vt_sshkey', 'private_key')

        # Deleting field 'SSHKey.fingerprint'
        db.delete_column('vt_sshkey', 'fingerprint')
