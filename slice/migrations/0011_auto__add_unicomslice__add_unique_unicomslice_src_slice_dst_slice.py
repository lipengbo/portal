...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UnicomSlice'
        db.create_table('slice_unicomslice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('src_slice', self.gf('django.db.models.fields.related.ForeignKey')(related_name='source_slice', to=orm['slice.Slice'])),
            ('dst_slice', self.gf('django.db.models.fields.related.ForeignKey')(related_name='target_slice', to=orm['slice.Slice'])),
        ))
        db.send_create_signal('slice', ['UnicomSlice'])

        # Adding unique constraint on 'UnicomSlice', fields ['src_slice', 'dst_slice']
        db.create_unique('slice_unicomslice', ['src_slice_id', 'dst_slice_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UnicomSlice', fields ['src_slice', 'dst_slice']
        db.delete_unique('slice_unicomslice', ['src_slice_id', 'dst_slice_id'])

        # Deleting model 'UnicomSlice'
        db.delete_table('slice_unicomslice')
    ...
    models = {
        ...
        'slice.unicomslice': {
            'Meta': {'unique_together': "(('src_slice', 'dst_slice'),)", 'object_name': 'UnicomSlice'},
            'dst_slice': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'target_slice'", 'to': "orm['slice.Slice']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'src_slice': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'source_slice'", 'to': "orm['slice.Slice']"})
        }
    }
