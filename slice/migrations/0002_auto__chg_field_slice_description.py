...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Slice.description'
        db.alter_column('slice_slice', 'description', self.gf('django.db.models.fields.CharField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'Slice.description'
        db.alter_column('slice_slice', 'description', self.gf('django.db.models.fields.TextField')())
