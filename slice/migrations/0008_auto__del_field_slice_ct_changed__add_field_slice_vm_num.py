...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Slice.ct_changed'
        db.delete_column('slice_slice', 'ct_changed')

        # Adding field 'Slice.vm_num'
        db.add_column('slice_slice', 'vm_num',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Slice.ct_changed'
        db.add_column('slice_slice', 'ct_changed',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Slice.vm_num'
        db.delete_column('slice_slice', 'vm_num')
