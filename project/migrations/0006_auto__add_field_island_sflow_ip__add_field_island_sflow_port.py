...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Island.sflow_ip'
        db.add_column('project_island', 'sflow_ip',
                      self.gf('django.db.models.fields.IPAddressField')(default='0.0.0.0', max_length=15, null=True),
                      keep_default=False)

        # Adding field 'Island.sflow_port'
        db.add_column('project_island', 'sflow_port',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Island.sflow_ip'
        db.delete_column('project_island', 'sflow_ip')

        # Deleting field 'Island.sflow_port'
        db.delete_column('project_island', 'sflow_port')
