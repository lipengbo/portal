...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectQuota'
        db.create_table('project_projectquota', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['project.Project'], unique=True)),
            ('member', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('slice', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('vm', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('band', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
        ))
        db.send_create_signal('project', ['ProjectQuota'])


    def backwards(self, orm):
        # Deleting model 'ProjectQuota'
        db.delete_table('project_projectquota')
